...
sap.ui.define(['sap/ui/core/UIComponent', 'ui2/choosingtech/model/models', 'sap/f/library', 'sap/f/FlexibleColumnLayoutSemanticHelper', 'sap/base/util/UriParameters'], function (UIComponent, models, library, FlexibleColumnLayoutSemanticHelper, UriParameters) {
  'use strict';
  ...
  return UIComponent.extend('ui2.choosingtech.Component', {
    ...
    onBeforeRouteMatched: function onBeforeRouteMatched(oEvent) {
      ...
      var sLayout = oEvent.getParameters().arguments.layout; // If there is no layout parameter, query for the default level 0 layout (normally OneColumn)
